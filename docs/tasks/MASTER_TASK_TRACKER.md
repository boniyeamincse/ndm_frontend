...
| 123 | Add registration form tests | Cover step transitions, field validation, file upload state, and submission error handling. This task can be implemented using AI-assisted development. | Done | Passed | Uploaded | Completed |
| 124 | Add member dashboard tests | Test profile rendering, task widgets, ID card download triggers, and empty states. This task can be implemented using AI-assisted development. | Done | Passed | Uploaded | Completed |
| 125 | Add admin dashboard tests | Test KPI rendering, pending list behavior, member actions, and list filtering. This task can be implemented using AI-assisted development. | Done | Passed | Uploaded | Completed |
